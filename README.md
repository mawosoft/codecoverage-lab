...
| Visual Studio integration  |    ✖<sup>1 2</sup> | ✔<sup>2</sup> | 1. May fail, because VStudio (including VStudio 2026) uses the .NetFx version of VSTest.<br>2. Everything must be configured and enabled in *.runsettings* file. |
